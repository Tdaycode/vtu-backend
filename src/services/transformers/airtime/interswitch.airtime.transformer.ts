...
interface IinterswitchAirtimeTransformer extends InterswitchCustomerValidationResponse {
  type: string,
  provider: string,
  productName: string,
  validate: boolean,
...
export function interswitchAirtimeTransformer(data: IinterswitchAirtimeTransformer): FormattedProductInfo {
